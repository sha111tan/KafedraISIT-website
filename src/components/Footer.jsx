      ...
      <div className="boxfooter">
            ...
            <div className="lilbox13">
              ...
              <div>
                <p className="kontakti">
                  ...
                  <br></br>
                  <div className="phone">Телефон: 8 (3919) 47-39-06</div>
                </p>
              </div>
            </div>
        ...
        <p align="center">
          <div className="footertext">
            <br></br>© 2023 ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ
            ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ ВЫСШЕГО ОБРАЗОВАНИЯ«ЗАПОЛЯРНЫЙ
            ГОСУДАРСТВЕННЫЙ УНИВЕРСИТЕТ ИМ. Н.М. ФЕДОРОВСКОГО»
          </div>
        </p>
      </div>
    </div>
